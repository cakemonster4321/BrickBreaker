...
start_menu_text = menu_font.render(f"Press left / right to start!",True,(255,255,255))
start_text_rect = start_menu_text.get_rect()
start_text_rect.center = (screen_width/2,screen_height/2-50)


end_menu_text2 = menu_font.render(f"Press left and right to continue!",True,(255,255,255))
end_text_rect2 = end_menu_text2.get_rect()
end_text_rect2.center = (screen_width/2,screen_height/2)


end_menu_text1 = menu_font.render(f"GAME  OVER!",True,(255,255,255))
